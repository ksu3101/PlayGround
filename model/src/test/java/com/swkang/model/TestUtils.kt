...
infix fun <T : Any> T?.shouldEqualTo(expected: T?) = this.apply {
    Assert.assertEquals(
        expected,
        this
    )
...
infix fun <T : Any> T?.shouldNotEqualTo(expected: T?) = this.apply {
    Assert.assertNotSame(
        expected,
        this
    )
...
fun <T : Any> T.verifyTimes(stubCounts: Int): T = Mockito.verify(this, Mockito.times(stubCounts))
...
fun <T : Any> T.verifyAtLeastOnce(): T = Mockito.verify(this, Mockito.atLeastOnce())
fun <T: Any> T.hasCalledAtLeastOnce(): T = this.verifyAtLeastOnce()

fun <T : Any> T.verifyAtLeast(minNumberOfInvocations: Int): T = Mockito.verify(this,
...
fun <T : Any> T.verifyAtMost(maxNumberOfInvocations: Int): T = Mockito.verify(this,
...
fun <T : Any> T.verifyCalls(wantedNumberOfInvocations: Int): T = Mockito.verify(this,
